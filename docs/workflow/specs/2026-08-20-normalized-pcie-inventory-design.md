...
they are never byte counts, bandwidth, or integer weights. Physical and logical-port identities
include the required parent selector components.
...
hierarchy selectors, `Decimal` percentage capacity, explicit unknowns, and serialization. Contract
