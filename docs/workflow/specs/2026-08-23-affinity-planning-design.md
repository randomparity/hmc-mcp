...
scalar form and rejects delimiters/control characters. It also caps the fully rendered aggregate
selector-option package, including flags, separators, and shell quoting, at 4096 UTF-8 bytes as a
conservative request-safety ceiling for the remote command budget;
