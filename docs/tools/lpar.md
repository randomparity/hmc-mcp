...
| `hmc_power_on_lpar` | `mutate` | `lpar.power_on` | `lpar` | `unrecorded` | `unrecorded` | `existing-runtime-guards` | Submit a PowerOn job for a logical partition, optionally against a named partition profile. |
