...
> the consequence claiming the fd-2 invariant is not enforced: CI now enforces the launch shape,
> while the runtime fd-2 condition remains unobserved under dash.
