...
- `from_mapping` iterates `model_fields` per call, and construction already runs
  full pydantic validation over every one of those fields; the enumeration is not
