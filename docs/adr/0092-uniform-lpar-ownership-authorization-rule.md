...
| `map_storage` | `operations/storage/resources.py:288` | guarded (`:309`) | #372 |
| `attach_disk_to_lpar` | `operations/lpar/provision.py:337` | guarded before the storage workflow (`:356`) | #372 |
| `mount_optical_media` | `operations/storage/resources.py:900` | guarded (`:921`) | — |
| `unmount_optical_media` | `operations/storage/resources.py:937` | guarded (`:976`) | — |
...
| `detach_storage_mapping` | `operations/storage/resources.py:387` | resolves the mapping's client LPAR and guards it before deletion (`:429`) | #448 |
