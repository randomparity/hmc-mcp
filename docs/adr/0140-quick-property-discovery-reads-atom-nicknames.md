...
that the vendored reference documents a lowercase `/quick/all` returning "a list of all defined
quick properties for type {R}" (`docs/refs/hmc-rest-api-p11/000-hmc-rest-apis.md`). Both halves of
