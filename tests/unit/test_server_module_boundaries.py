...
def test_domain_handlers_live_in_focused_modules() -> None:
    expected_modules = {
        ...
        vios.hmc_power_on_vios: "hmc_mcp.server_tools.vios.core",
        vios.hmc_power_off_vios: "hmc_mcp.server_tools.vios.core",
...
def test_network_cli_commands_follow_operation_domains() -> None:
    expected_modules = {
        cli_network.network_list_networks: "hmc_mcp.cli_commands.virtualization.network",
        cli_pcie.network_list_sriov_adapters: "hmc_mcp.cli_commands.virtualization.pcie",
        cli_vnic.network_list_vnics: "hmc_mcp.cli_commands.virtualization.vnic",
    }
