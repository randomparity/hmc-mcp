...
Equivalent to `live_test_runner.py --group vmedia`, and named so that an
operator picking an arm from the runbook cannot mistype the group or land on
a different one. Results go to `test-results-vmedia.json`.

**This mutates a managed system.** Run `scripts/live_test_preflight.py
--group vmedia` first to see what it will touch.
